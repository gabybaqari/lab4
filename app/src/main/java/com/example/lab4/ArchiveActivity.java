...
public class ArchiveActivity extends AppCompatActivity {
    ...
    public void hardcode(){
        for(int i=0;i<archiveList.size();i++){
            ...
            printOut.fromText(archiveList.get(i).getFrom(), orderInfo);
            printOut.toText(archiveList.get(i).getTo(), orderInfo);
            printOut.dateText(archiveList.get(i).getDate(), orderInfo);
            printOut.weightText(archiveList.get(i).getWeight(), orderInfo);
            printOut.isGlassText(archiveList.get(i).isGlass(), orderInfo);
            printOut.addToOrderList(newArchiveList, orderInfo);
